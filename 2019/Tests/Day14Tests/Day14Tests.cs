...
namespace Tests.Day14Tests
{
	public class Day14Tests
	{
		...
		public void FindsRequiredOre(string input, double expectedOre)
		{
			...
			var day14 = new Solution(puzzle);

			// Act
			string requiredOre = day14.SolvePart1();

			// Assert
			requiredOre.ShouldBe($"Part 1: {expectedOre}");
		}

		private static IEnumerable<object[]> FindsRequiredOreCases()
		{
		...
		public void FindsMaxFuelForOre(string input, int expectedFuel)
		{
			...
			// Act
			string maxFuel = day14.SolvePart2();

			// Assert
			maxFuel.ShouldBe($"Part 2: {expectedFuel}");
		}
