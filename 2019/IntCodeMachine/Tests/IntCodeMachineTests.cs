...
namespace CommonTests
{
    public class IntCodeMachineTests
    {
        ...
        {
            // Outputs the input.
            yield return new object[] { new BigInteger[] { 3, 0, 4, 0, 99 }, 43, new BigInteger[] { 43, 0, 4, 0, 99 }, new string[] { "43", "Halt" } };
            // Compare input to 8, output truthy/falsey
            yield return new object[] { new BigInteger[] { 3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8 }, 43, new BigInteger[] { 3, 9, 8, 9, 10, 9, 4, 9, 99, 0, 8 }, new string[] { "0", "Halt" } };
            // Input < 8, output truthy/falsey
            yield return new object[] { new BigInteger[] { 3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8 }, 7, new BigInteger[] { 3, 9, 7, 9, 10, 9, 4, 9, 99, 1, 8 }, new string[] { "1", "Halt" } };
            // Compare input to 8, output truthy/falsey
            yield return new object[] { new BigInteger[] { 3, 3, 1108, -1, 8, 3, 4, 3, 99 }, 43, new BigInteger[] { 3, 3, 1108, 0, 8, 3, 4, 3, 99 }, new string[] { "0", "Halt" } };
            // Input < 8, output truthy/falsey
            yield return new object[] { new BigInteger[] { 3, 3, 1107, -1, 8, 3, 4, 3, 99 }, 7, new BigInteger[] { 3, 3, 1107, 1, 8, 3, 4, 3, 99 }, new string[] { "1", "Halt" } };
        }
        ...
        private static IEnumerable<object[]> JumpCases()
        {
            ...
            yield return new object[] { new BigInteger[] { 3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9 }, 43, new BigInteger[] { 3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, 43, 1, 1, 9 }, new string[] { "1", "Halt" } };
            // Output truthy/falsey if input is non-zero
            yield return new object[] { new BigInteger[] { 3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1 }, 43, new BigInteger[] { 3, 3, 1105, 43, 9, 1101, 0, 0, 12, 4, 12, 99, 1 }, new string[] { "1", "Halt" } };
            // Output 999 if input < 8, 1000 if input == 8, 1001 if input > 8
            yield return new object[] { new BigInteger[] { 3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36, 98, 0, 0, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104, 999, 1105, 1, 46, 1101, 1000, 1, 20, 4, 20, 1105, 1, 46, 98, 99 }, 43, new BigInteger[] { 3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36, 98, 1001, 43, 1002, 21, 125, 20, 4, 20, 1105, 1, 46, 104, 999, 1105, 1, 46, 1101, 1000, 1, 20, 4, 20, 1105, 1, 46, 98, 99 }, new string[] { "1001", "Halt" } };
        }
        ...
        private static IEnumerable<object[]> RelativeBaseCases()
        {
            ...
            yield return new object[] { new BigInteger[] { 109, 19, 99 }, 19, new string[] { "Halt" } };
            // Quine
            yield return new object[] { new BigInteger[] { 109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99 }, 16, new string[] { "109", "1", "204", "-1", "1001", "100", "1", "100", "1008", "100", "16", "101", "1006", "101", "0", "99", "Halt" } };
        }
        ...
        private static IEnumerable<object[]> BigIntegerCases()
        {
            ...
            yield return new object[] { new BigInteger[] { 1102, 34915192, 34915192, 7, 4, 7, 99, 0 }, new string[] { "1219070632396864", "Halt" } };
